...
class Tablero:
    ...
    def ejecutar_accion(self, accion):
        ...
        para_nxm = []
        intervalo_superior = 3
        for intervalo_inferior in range(0,len(nuevos_estados),3):
            para_nxm.append(nuevos_estados[intervalo_inferior:intervalo_superior])
            intervalo_superior += 3
        
        #2da fase
        if indice_vacio_1 in range(0, len(nuevos_estados)*1//5):
            fila = 0
        elif indice_vacio_1 in range(3, len(nuevos_estados)*2//5):
            fila = 1
        elif indice_vacio_1 in range(6, len(nuevos_estados)*3//5):
            fila = 2
        elif indice_vacio_1 in range(9, len(nuevos_estados)*4//5):
            fila = 3
